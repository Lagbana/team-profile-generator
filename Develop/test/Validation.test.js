...
test("User input (id) has to be an integer", () => {
    ...
    expect(validate.officeValidation(str)).toBe("Please press the up arrow button and enter a valid office number");
    expect(validate.officeValidation(float)).toBe("Please press the up arrow button and enter a valid office number");
});
